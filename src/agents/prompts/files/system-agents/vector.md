...
- Step 1: Identify what vector database operations are needed for the task
- Step 2: Determine the appropriate action (index, search, or delete)
- Step 3: Extract or prepare the required parameters for the operation
- Step 4: Execute the vector database operation using the vector_db tool
- Step 5: Format and return the results clearly
