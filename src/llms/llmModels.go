...
const OpenRouterAPIKeyEnvVar = "AP_OPENROUTER_API_KEY"
...
// Models for OpenRouter (OpenAI-compatible slugs)
const OPENROUTER_GPT4O = "openai/gpt-4o"
const OPENROUTER_GPT4O_MINI = "openai/gpt-4o-mini"

var DefaultModel = map[string]string{
	"openai":     OPENAI_GPT5_1,
	"deepseek":   DEEPSEEK_CHAT,
	"togetherai": TOGETHERAI_Llama3170BInstructTurbo,
	"openrouter": OPENROUTER_GPT4O,
}
...
var DefaultCheapModel = map[string]string{
	...
	"openrouter": OPENROUTER_GPT4O_MINI,
}
...
var ProviderAPIKeyEnvVar = map[string]string{
	...
	"openrouter": OpenRouterAPIKeyEnvVar,
}
...
var KnownModels = map[string]ModelInfo{
	...
	OPENROUTER_GPT4O: {
		Name: OPENROUTER_GPT4O, Provider: "openrouter",
		ContextWindow: 128_000, MaxOutputTokens: 16_384,
		SupportsVision: true,
	},
	OPENROUTER_GPT4O_MINI: {
		Name: OPENROUTER_GPT4O_MINI, Provider: "openrouter",
		ContextWindow: 128_000, MaxOutputTokens: 16_384,
		SupportsVision: true,
	},
}
