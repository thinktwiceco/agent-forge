...
// NewConfigFromPath creates a new Config instance by loading environment variables
// from a specific .env file path.
//
// Parameters:
//   - envPath: Path to the .env file to load
//
// Returns:
//   - *Config: The loaded configuration
//   - error: An error if the .env file cannot be loaded or validation fails
func NewConfigFromPath(envPath string) (*Config, error) {
